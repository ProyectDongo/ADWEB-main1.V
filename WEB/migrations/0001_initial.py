    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rut_representante', models.CharField(max_length=12, validators=[WEB.views.scripts.validators.validators.validar_rut])),
                ...
                ('metodo_pago', models.CharField(choices=[('manual', 'Manual'), ('automatico', 'Automático')], default='manual', max_length=20)),
                ('frecuencia_pago', models.CharField(blank=True, choices=[('mensual', 'Mensual'), ('anual', 'Anual')], max_length=20, null=True)),
                ('banco', models.CharField(blank=True, max_length=100, null=True)),
                ('tipo_cuenta', models.CharField(blank=True, choices=[('ahorro', 'Ahorro'), ('corriente', 'Corriente')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apellidoM', models.CharField(blank=True, max_length=12)),
                ('nombre', models.CharField(max_length=100)),
                ('celular', models.CharField(blank=True, max_length=20)),
                ('email', models.EmailField(max_length=254)),
