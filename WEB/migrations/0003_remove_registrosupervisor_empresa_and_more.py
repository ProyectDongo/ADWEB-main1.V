...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('WEB', '0002_alter_registrotrabajador_options_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('ADMIN', 'Administrador'), ('SUPERVISOR', 'Supervisor'), ('TRABAJADOR', 'Trabajador')], default='TRABAJADOR', max_length=20)),
        ...
        migrations.AddField(
            model_name='registropermisos',
            name='usuario',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='permisos', to='WEB.usuario'),
        ),
